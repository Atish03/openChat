...
export default function Login() {
    ...
    const handleLogin = async() => {
        ...
        const req = await toast.promise(fetch("/api/login", {
            method: "POST",
    ...
    return (
        <div className="flex flex-col gap-3">
            <h1 className="indent-1.5 text-slate-600 font-bold text-3xl rounded-lg bg-slate-100 p-3">Login</h1>
            <div className="flex flex-col gap-5 p-5 bg-slate-100 rounded-lg">
                ...
                <button onClick={handleLogin} className="p-3 text-slate-600 font-semibold indent-1.5 text-lg bg-violet-300 rounded-lg transition hover:shadow-lg">Continue</button>
                <Link to="/app/auth/register"><p className="indent-1.5 underline text-slate-600">I do not have an account</p></Link>
